...
<section>
    <div class="container">
        <h1 class="bottom-line">Driver Sign In</h1>
        <h3 class="text-center text-uppercase delivery-info">Please, enter your login and password for sign in as driver</h3>
        <form method="post" action="/users/driver_login/" class="text-center">
            <div class="row">
                <div class="col-sm-6">
            ...
            <input type="submit" class="text-center" class="button-yellow button-long with-right-arrow form-submit-trigger" value="Sign In As Driver"/>
        </form>
